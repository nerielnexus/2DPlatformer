...
public static class DebugExtension
{
	...
	*/
	public static void DebugBounds(Bounds bounds, float pos, Color color, float duration = 0, bool depthTest = true)
	{
		Vector3 center = bounds.center;
		...
		Vector3 ruf = center + new Vector3(x, y+pos, z);
		Vector3 rub = center + new Vector3(x, y+pos, -z);
		Vector3 luf = center + new Vector3(-x, y+pos, z);
		Vector3 lub = center + new Vector3(-x, y+pos, -z);

		Vector3 rdf = center + new Vector3(x, -y+pos, z);
		Vector3 rdb = center + new Vector3(x, -y + pos, -z);
		Vector3 lfd = center + new Vector3(-x, -y +pos, z);
		Vector3 lbd = center + new Vector3(-x, -y+pos, -z);
